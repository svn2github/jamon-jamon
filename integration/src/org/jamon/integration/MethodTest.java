    ...
    extends TestBase
{
    public void testSimpleMethod()
        throws Exception
    {
        new Method(getTemplateManager()).writeTo(getWriter()).render();
    ...
    public void testInheritedMethod()
        throws Exception
    {
        new MethodChild(getTemplateManager()).writeTo(getWriter()).render();
    ...
    public void testOverriddenMethod()
        throws Exception
    {
        new MethodOverride(getTemplateManager()).writeTo(getWriter()).render();
        final String methodsOutput =
