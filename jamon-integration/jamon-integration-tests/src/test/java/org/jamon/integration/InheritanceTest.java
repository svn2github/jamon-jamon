...
public class InheritanceTest extends TestBase {
  public void testParentCall() throws Exception {
    assertTrue(Modifier.isAbstract(Parent.class.getModifiers()));
  }

  public void testChildSettingParentOptionalArg() throws Exception {
    Child child = new Child();
    child.setOpt2("o2j");
    child.render(getWriter(), 0, new Integer(1), "s", true);
    String childString = "{s 0 true o1c o5p o7c}";
    checkOutput("0 1 " + childString + " " + childString + " o1c o2j o3p o4p o5p o6p");
  }

  public void testChildWithDefaults() throws Exception {
    new Child().render(getWriter(), 0, new Integer(1), "s", true);
    String childString = "{s 0 true o1c o5p o7c}";
    checkOutput("0 1 " + childString + " " + childString + " o1c o2p o3p o4p o5p o6p");
  }

  public void testGrandchildWithDefaults() throws Exception {
    new Grandchild().render(getWriter(), 0, new Integer(1), "s", true, Boolean.FALSE);
    String childString =
      "{s 0 true {s 1 false o1g o3g o5m o6p o7g o9m o10g} o1g o2m o5m o6p o7g o8m o9m}";
    checkOutput("0 1 " + childString + " " + childString + " o1g o2m o3g o4p o5m o6p");
  }

  public void testChildWithDefaultsViaParentRenderer() throws Exception {
    new Child().makeParentRenderer("s", true).render(getWriter(), 0, new Integer(1));
    String childString = "{s 0 true o1c o5p o7c}";
    checkOutput("0 1 " + childString + " " + childString + " o1c o2p o3p o4p o5p o6p");
  }

  public void testChildSettingParentOptionalArgViaParentRenderer() throws Exception {
    new Child().makeParentRenderer("s", true).setOpt2("o2j").render(getWriter(), 0, new Integer(1));
    String childString = "{s 0 true o1c o5p o7c}";
    checkOutput("0 1 " + childString + " " + childString + " o1c o2j o3p o4p o5p o6p");
  }

  public void testMiddleParentRenderSettingParentOptionalArg() throws Exception {
    new Grandchild()
      .makeParentRenderer(Boolean.FALSE).setOpt2("o2j")
      .makeParentRenderer("s", true)
      .render(getWriter(), 0, new Integer(1));
    String childString =
      "{s 0 true {s 1 false o1g o3g o5m o6p o7g o9m o10g} o1g o2j o5m o6p o7g o8m o9m}";
    checkOutput("0 1 " + childString + " " + childString + " o1g o2j o3g o4p o5m o6p");
  }

  public void testGrandchildWithDefaultsViaParentRenderer() throws Exception {
    new Grandchild()
  ...
  public void testParentAnnotations() {
    ...
    NameType.checkArgs(
      ...
      new NameType("i", "int"),
      new NameType("j", "Integer"));
    NameType.checkArgSet(
      templateAnnotation.optionalArguments(),
      new NameType("opt1", "String"),
      new NameType("opt2", "String"),
      new NameType("opt3", "String"),
      new NameType("opt4", "String"),
      new NameType("opt5", "String"),
      new NameType("opt6", "String"));
  ...
  public void testChildAnnotations() {
    ...
    NameType.checkArgs(
      ...
      new NameType("i", "int"),
      new NameType("j", "Integer"),
      new NameType("a", "String"),
      new NameType("k", "boolean"));
    NameType.checkArgSet(
      templateAnnotation.optionalArguments(),
      new NameType("opt1", "String"),
      new NameType("opt2", "String"),
  ...
  public void testRecompilation() throws Exception {
    new Child(getRecompilingTemplateManager()).render(getWriter(), 0, new Integer(1), "s", true);
  }

  public void testHiddenParentRequiredArgs() throws Exception {
    checkCompilationFailure("/test/jamon/broken/RequiredArgSnoopingChild");
  }

  public void testHiddenParentOptionalArgs() throws Exception {
    checkCompilationFailure("/test/jamon/broken/OptionalArgSnoopingChild");
  }

  public void testHiddenParentFragmentArgs() throws Exception {
    checkCompilationFailure("/test/jamon/broken/FragmentArgSnoopingChild");
  }

  public void testLibOnlyParentFragment() throws Exception {
    getRecompilingTemplateManager().constructProxy("/test/jamon/external/ChildFragment");
  }

  public void testNonParentChildCall() throws Exception {
    expectParserError(
      "NonParentChildCall",
      "<& *CHILD &> cannot be called from a template without an <%abstract> tag", 1, 1);
  }

  public void testMultipleParents() throws Exception {
    expectParserError("MultipleParents", "a template cannot extend multiple templates", 2, 1);
  }
